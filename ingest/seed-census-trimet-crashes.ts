 ...
 *   npx tsx ingest/seed-census-trimet-crashes.ts
 *   npx tsx ingest/seed-census-trimet-crashes.ts --census-only
 *   npx tsx ingest/seed-census-trimet-crashes.ts --trimet-only
 *   npx tsx ingest/seed-census-trimet-crashes.ts --crashes-only
 */
