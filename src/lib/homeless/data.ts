...
export const PAYERS: Payer[] = [
  { id: "federal", name: "Federal Medicaid", pays: "The federal matching share of eligible Medicaid expenditure", captures: "No automatic claim-by-claim share of savings under CCO capitation", lever: "none", leverNote: "Changes depend on payment arrangements, eligible expenditure and future rate-setting; federal financing is not a local reinvestment account." },
  { id: "state", name: "OHA and the State", pays: "State share, CCO capitation and applicable directly funded services", captures: "Budget effects depend on rates, contracts, service obligations and future appropriations", lever: "none", leverNote: "Identify the funding authority and recurring operating commitment separately from construction funding." },
  { id: "cco", name: "CCOs and health plans", pays: "Covered care under capitation, subcontracts and risk arrangements", captures: "Lower claims can affect plan finances; retained amounts depend on the contract", lever: "obligated", leverNote: "SHARE depends on financial conditions and spending requirements. Its housing priority does not automatically fund the County’s chosen pipeline. See the 2026 guidance below." },
  { id: "hospital", name: "Hospitals", pays: "Staffed emergency and inpatient capacity, including uncompensated care", captures: "Changes in uncompensated care, costs and revenue vary by payer and service", lever: "willing", leverNote: "Past housing co-investments provide precedents. New commitments require a service and financing agreement." },
  { id: "county", name: "Multnomah County", pays: "Jail, County health and homelessness services", captures: "Variable costs or freed capacity may change; larger cash savings require actual budget changes", lever: "conditional", leverNote: "Fewer service episodes do not automatically release the fixed costs of an operating facility." },
  { id: "city", name: "City of Portland", pays: "Emergency response, outreach, shelter and public-space services", captures: "Effects depend on staffing, deployment and costs actually avoided", lever: "conditional", leverNote: "Track service demand, outcomes and spending separately; better outcomes do not require an assumption of full financial payback." },
];
...
export const DOORS: Door[] = [
  { n: 1, title: "Identify services an eligible benefit covers", body: "Clinical care, case management or tenancy support may be reimbursable when the benefit, person, provider and service meet the applicable requirements. Confirm authority, authorization, contracted rates and actual payment before replacing local funding. A benefit in another state does not establish Oregon coverage.", durability: "most durable", deadline: "Varies by state-plan, waiver and contract authority", source: "ohaHousingMedicaid" },
  { n: 2, title: "Secure a specific reinvestment commitment", body: "SHARE can support qualifying housing investments, including eligible capital. The designation depends on financial conditions; spending must meet guidance, community-priority and partnership requirements. A housing priority is not an automatic earmark for the County’s pipeline. Verify the approved plan and funding commitment.", durability: "durable", deadline: "Review each CCO’s applicable financial calculation and spending plan", source: "shareGuidance" },
  { n: 3, title: "Help eligible households obtain rent benefits", body: "Oregon’s HRSN benefit can provide qualifying households with time-limited rent support. Effective enrollment requires staffed outreach, documentation, eligibility decisions and payment follow-through. Budget those operations and measure rent actually paid; intake improvement is not cost-free.", durability: "time-limited", deadline: "Waiver ends Sept. 30, 2027; check eligibility and renewal decisions", source: "medicaidHousing" },
