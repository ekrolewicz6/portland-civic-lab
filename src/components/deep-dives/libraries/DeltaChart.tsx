  ...
  return (
    <div className="overflow-hidden rounded-sm border border-[var(--color-parchment)] bg-white">
      <div className="flex flex-wrap items-center justify-between gap-x-6 gap-y-2 border-b border-[var(--color-parchment)] bg-[var(--color-paper-warm)] px-5 py-4 sm:px-7">
        ...
        <div className="flex items-center gap-5 font-mono text-[10px] uppercase tracking-[0.12em] text-[var(--color-ink-muted)]">
              ...
              <div className="relative mt-7 h-14 lg:mt-0">
                ...
                {nowPct !== null ? (
                  <div className="absolute top-1/2 -translate-x-1/2 -translate-y-1/2" style={{ left: `${nowPct}%` }}>
                    ...
                    <span
                      className={`absolute top-full mt-1.5 whitespace-nowrap font-mono text-[12px] font-bold tabular-nums text-[var(--color-clay)] ${
                  ...
                  <span className="absolute left-0 top-full mt-1.5 whitespace-nowrap font-mono text-[11px] italic text-[var(--color-clay)]">
                ...
                <div className="absolute top-1/2 -translate-x-1/2 -translate-y-1/2" style={{ left: `${targetPct}%` }}>
                  ...
                  <span className="absolute left-1/2 bottom-full mb-1.5 -translate-x-1/2 whitespace-nowrap font-mono text-[12px] font-bold tabular-nums text-[var(--color-canopy)]">
                    {d.targetLabel}
                  </span>
                </div>
                {/* gap label */}
                {gap !== null && nowPct !== null ? (
                  <span
                    className="absolute bottom-full mb-1.5 -translate-x-1/2 whitespace-nowrap font-mono text-[10px] uppercase tracking-[0.1em] text-[var(--color-ember)]"
