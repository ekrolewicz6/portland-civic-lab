  ...
  return (
    <div className="space-y-4">
      <div className="rounded-sm border border-[var(--color-parchment)] bg-white p-5 sm:p-7">
          ...
          {groups.map((g) => (
            <div key={g.label}>
              <div className="flex items-baseline justify-between">
                ...
                <span className="text-[12px] text-[var(--color-ink-muted)]">of 100</span>
              </div>
              <p className="mt-1 text-[13px] font-semibold text-[var(--color-ink)]">{g.label}</p>
              <div className="mt-3">
        ...
        <p className="mt-5 max-w-2xl text-[13.5px] leading-relaxed text-[var(--color-ink-light)]">
      ...
      <div className="rounded-sm border border-[var(--color-parchment)] bg-white p-5 sm:p-7">
        ...
        <div className="mt-2 flex flex-wrap justify-between gap-x-4 gap-y-1 font-mono text-[11px] uppercase tracking-[0.1em]">
