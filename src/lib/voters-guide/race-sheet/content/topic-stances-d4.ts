...
export const topicStancesD4: TopicStance[] = [
  ...
  stance("eli-arnold", "new-taxes", "opposes", "No new taxes, fees",
    "Says he will not support raising taxes and fees, and would use existing clean energy resources to move toward fareless transit.",
    pamphlet(65)),
  stance("eli-arnold", "police-staffing", "supports", "Fill vacancies, then grow",
    ...
    arnoldEmail),
  stance("eli-arnold", "street-response", "partial", "Scale PSR citywide",
    "Would expand Street Response scope in 2027–2028 and citywide by 2029–2031 so calls go to the right responder; the plan does not say whether it should run 24/7.",
    arnoldSafety),
  ...
  /* ── Olivia Clark ───────────────────────────────────────────────────── */
  stance("olivia-clark", "camp-removal", "partial", "Remove street camping",
    "Would make the city safe by removing street camping and public drug use while adding shelter beds, sobering stations and treatment; the page does not say whether to keep removal funding at current levels.",
    clarkPriorities),
  ...
  /* ── Jamey Evenstar ─────────────────────────────────────────────────── */
  stance("jamey-evenstar", "new-taxes", "supports", "Fee on non-primary homes",
  ...
  stance("mitch-green", "street-response", "supports", "Fund PSR toward 24/7",
    ...
    greenRecord),
  stance("mitch-green", "water-rates", "partial", "Bull Run cost controls",
    "Says he pushed for cost controls on the Bull Run project to prevent water rates from doubling; the statement does not say whether bills should rise to pay for the plant.",
    pamphlet(62)),
  ...
  swept("matt-schulte", "moda", "mixed", "Back terms, demand more",
    ...
    schulteEmail),
  swept("matt-schulte", "new-taxes", "opposes", "Business taxes not first",
  ...
  stance("eric-zimmerman", "police-staffing", "supports", "1,000 sworn officers",
    "Would expand the Police Bureau to 1,000 sworn officers and grow patrol and investigations, and would consider a short-term reduction in other support roles until fully staffed.",
    zimmermanSafety),
  stance("eric-zimmerman", "camp-removal", "supports", "Yes to camp cleanups",
    "His statement says “YES to Camp Cleanups” and calls shelters, enforcement, camp cleanups and mental-health and addiction treatment all important.",
    pamphlet(64)),
  stance("eric-zimmerman", "street-response", "partial", "PSR may transport patients",
    "Would let Street Response transport people to sobering centers and psychiatric emergency care; the page does not say whether it should run 24/7.",
    zimmermanSafety),
];
