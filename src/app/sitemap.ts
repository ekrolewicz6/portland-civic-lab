...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/spaces`, lastModified: now, changeFrequency: "weekly", priority: 0.6 },
    ...
    { url: `${BASE_URL}/progress-report`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
