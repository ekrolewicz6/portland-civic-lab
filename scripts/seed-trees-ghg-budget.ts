 ...
 *   npx tsx scripts/seed-trees-ghg-budget.ts
 *   npx tsx scripts/seed-trees-ghg-budget.ts --trees-only
 *   npx tsx scripts/seed-trees-ghg-budget.ts --ghg-only
 *   npx tsx scripts/seed-trees-ghg-budget.ts --budget-only
 */
