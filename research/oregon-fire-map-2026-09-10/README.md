...
Updated September 11, 2026. Edan Krolewicz, Jenna Knobloch and Dominic Kuklawood. Enough public data exists for an initial map; comprehensive coverage and a site-selection explanation for every burn remain goals, not established facts.
...
| File | Purpose |
|---|---|
| [Audit](audit-2026-09-11.md) | Corrections, evidence, missing data, priorities and release gate |
| [Sourcebook](sourcebook.html) | Updated local, readable research packet; replaces the earlier artifact’s content |
| [Inventory](data-inventory.md) | Existing sources plus ecological permits, refuge/park histories and LTDL |
...
| [Verification](verification.md) | Commands, results, remaining source limitations and review checklist |

## Use this now

1. Review representative mapped records and the Woodpecker explanation with co-authors. The story has no invented map pin.
2. Send individually reviewed requests first to ODF, DEQ, LRAPA and Oregon Explorer. Ask ODF for a 2025 sample/schema, registrations, authorizations and individual ignitions/accomplishments. Begin tribal partnership conversations alongside these requests.
...
4. Edan authorized production release on September 11, 2026. Representative-record review with Jenna and Dominic remains an editorial follow-up. Six-hour archival configuration activates with the production deployment; see verification.md for release results.
