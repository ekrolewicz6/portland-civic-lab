...
/**
 * One-line descriptor for footers and meta descriptions. Keep this
 * consistent across the main site, the Parks Atlas, and the Permits tools.
 */
export const TAGLINE =
  "A company that builds free, public tools to help Portlanders understand their city.";
