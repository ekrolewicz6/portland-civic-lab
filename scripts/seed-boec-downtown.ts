 ...
 *   npx tsx scripts/seed-boec-downtown.ts
 *   npx tsx scripts/seed-boec-downtown.ts --boec-only
 *   npx tsx scripts/seed-boec-downtown.ts --downtown-only
 */
...
// Data extracted from BOEC Director's Report PDFs (March 2025 - March 2026)
// Each metric verified against the structured tables in each monthly report.
...
const boecData: BOEC911Row[] = [
  // 911 Call Answering Performance from Director's Reports
  // National NENA standard: 90% answered within 15 seconds
  {
    month: "2025-03-01",
  ...
  },
  {
    month: "2025-07-01",
    total_911_calls: null,
    pct_answered_15sec: 60,
    avg_wait_seconds: 29,
    non_emergency_wait_seconds: null,
    authorized_fte: 136,
    certified_dispatchers: 107,
    vacancies: 15,
  },
  {
    month: "2025-08-01",
  ...
  },
  {
    ...
    non_emergency_wait_seconds: null,
    authorized_fte: 136,
    certified_dispatchers: 109,
    vacancies: 14,
  },
  {
    month: "2025-10-01",
    total_911_calls: null,
    pct_answered_15sec: 70,
    avg_wait_seconds: 21,
    non_emergency_wait_seconds: null,
    authorized_fte: 136,
    certified_dispatchers: 110,
    vacancies: 13,
  },
  {
    month: "2025-11-01",
    total_911_calls: null,
    pct_answered_15sec: 72,
    avg_wait_seconds: 18,
    non_emergency_wait_seconds: null,
    authorized_fte: 136,
    certified_dispatchers: 110,
  ...
  },
  {
    month: "2026-02-01",
    total_911_calls: null,
    pct_answered_15sec: 78,
    avg_wait_seconds: 14,
    non_emergency_wait_seconds: null,
    authorized_fte: 136,
    certified_dispatchers: 112,
    vacancies: 12,
  },
  {
    month: "2026-03-01",
    total_911_calls: 44333,
    pct_answered_15sec: 79,
    avg_wait_seconds: 13,
    non_emergency_wait_seconds: null,
    authorized_fte: 136,
    certified_dispatchers: 112,
  ...
  for (const row of boecData) {
    await sql`
      INSERT INTO safety.boec_911_monthly (
        month, total_911_calls, pct_answered_15sec, avg_wait_seconds,
...
async function main() {
  ...
  if (!downtownOnly) {
    console.log("    - safety.boec_911_monthly (13 months, Mar 2025 - Mar 2026)");
