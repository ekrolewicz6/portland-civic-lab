...
export default function OrgChartPage() {
  return (
    <div className="bg-[var(--color-paper)]">
      ...
      <section className="mx-auto max-w-[1400px] 3xl:max-w-[1800px] px-5 py-10 sm:px-8 sm:py-12 lg:px-12">
        <OrgChartExplorer />
      </section>

      <section className="border-t border-[var(--color-parchment)]">
        <div className="mx-auto max-w-[1400px] 3xl:max-w-[1800px] px-5 py-12 sm:px-8 sm:py-14 lg:px-12">
