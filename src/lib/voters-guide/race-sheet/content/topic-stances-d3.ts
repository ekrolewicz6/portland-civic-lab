...
export const topicStancesD3: TopicStance[] = [
  ...
  sweepStance("ali-beaudoin", "street-fee", "mixed", "Only if proven",
    ...
    beaudoinEmail),
  sweepStance("ali-beaudoin", "water-rates", "mixed", "Phased, with protections",
  ...
  stance(
    ...
    "opposes",
    "Grow the tax base",
    "Says Portland cannot tax its way out of a shrinking base and must grow it back, and would right-size the business tax structure to stay competitive.",
    pamphlet(58),
  ),
  stance(
    "matthias-hallett",
  ...
  stance(
    ...
    "moda",
    "partial",
    "Fair deal for Portlanders",
    "Says she fought for a fair deal for Portlanders in the Moda Center negotiations; the statement does not say how much public money the renovation should get.",
    pamphlet(54),
  ),
  stance(
    "tiffany-koyama-lane",
  ...
  sweepStance(
    ...
    "Would consistently enforce clear boundaries citywide: when appropriate shelter is available, camping should not be allowed indefinitely in rights-of-way, parks or on private property; the page does not say whether removal funding should stay at current levels.",
    legreePlan,
  ),
  sweepStance(
    "keir-legree",
  ...
  stance(
    ...
    "partial",
    "Lower water bills",
    "Says water and sewer bills are over four times Las Vegas’s and rising, and would work to reduce infrastructure project costs to lower bills; the statement does not say whether bills should rise to pay for the filtration plant.",
    pamphlet(59),
  ),
  ...
  sweepStance(
    ...
    "Says she prepared legislation strengthening oversight of the homelessness contractor Urban Alchemy while supporting a shift away from costly homeless camp sweeps toward public bathrooms, sanitation and low-barrier jobs.",
    morilloCouncil2026,
  ),
  stance(
    "angelita-morillo",
  ...
  stance(
    ...
    "moda",
    "mixed",
    "Fair deal, break even",
    "Wants to keep the Blazers and says he is fighting for a fair deal in which the city gets as much money out of the Moda Center as it puts in.",
    novick,
  ),
  stance(
    "steve-novick",
    "new-taxes",
    "mixed",
    "Replace the Arts Tax",
    "Voted against increasing the Arts Tax and wants to replace it without cutting arts funding, possibly by folding it into the Children’s Levy; hopes to sustain parks without another tax increase.",
    novick,
  ),
  stance(
    "steve-novick",
  ...
  stance(
    ...
    "Says he led the fight against a proposal to slash funding for removing the most hazardous camps; does not support indiscriminate sweeps.",
    novick,
  ),
  stance(
    "steve-novick",
    ...
    "Is working to move 911 welfare-check calls to unarmed responders and to get Medicaid to reimburse Street Response; the page does not say whether Street Response should expand to a 24/7 role.",
    novick,
  ),
  stance(
    "steve-novick",
    ...
    "mixed",
    "Offset with PCEF",
    "Suggests Clean Energy Fund money could pay part of the water filtration plant and help offset water-rate increases.",
    novick,
  ),
  sweepStance(
    "steve-novick",
  ...
  stance(
    ...
    "Notes rates rose 8.1 percent and the Water Bureau pays about $100 million a year in debt service; would judge borrowing by monthly household cost. The statement does not say whether to raise rates for filtration.",
    pamphlet(59),
  ),
  ...
  sweepStance(
    ...
    "new-taxes",
    "mixed",
    "Tax long-vacant rentals",
    "Told City Club in 2024 the City should tax rental units left vacant for long periods and replace the one-size-fits-all Arts Tax with a variable tax.",
    cityClub2024("Parker"),
  ),
  sweepStance(
    "terry-parker",
  ...
  stance(
    ...
    "mixed",
    "Needs, not a number",
    "If Portland needs more police, says it should start with police accountability and be intentional about where positions go, and would consider strengthening detectives and specialized units; staffing should follow need, not a set number.",
    sollitt,
  ),
  ...
  sweepStance(
    ...
    "Answered no, but would pause any increase or cut until a clear accounting shows what the program spends and achieves; agrees rights-of-way must stay clear and wants a more compassionate, coordinated approach with the County and providers.",
    sollittEmail,
  ),
  sweepStance(
    "tom-sollitt",
  ...
  stance(
    ...
    "Supports public safety staffing and resources that let police follow through on investigations and fix emergency response times; the page does not say whether that means hiring more sworn officers.",
    torres,
  ),
