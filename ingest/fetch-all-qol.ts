 ...
 *
 * Usage: npx tsx ingest/fetch-all-qol.ts [--skip-airnow] [--skip-census] [--skip-trimet] [--skip-seed] [--skip-parks] [--skip-pavement]
 */
...
const scripts: ScriptRun[] = [
  { name: "AirNow AQI", script: "ingest/fetch-airnow.ts", skipFlag: "airnow", cadence: "daily" },
  { name: "Census QoL (rent, education, income)", script: "ingest/fetch-census-qol.ts", skipFlag: "census", cadence: "annually" },
  { name: "TriMet Ridership + Bike/Trails", script: "ingest/fetch-trimet-ridership.ts", skipFlag: "trimet", cadence: "monthly" },
  { name: "QoL Static Data (cultural, canopy, broadband)", script: "ingest/seed-quality-extras.ts", skipFlag: "seed", cadence: "quarterly" },
  { name: "Parks & Amenities", script: "ingest/fetch-parks.ts", skipFlag: "parks", cadence: "quarterly" },
  { name: "PBOT Pavement Condition", script: "ingest/fetch-pbot-pavement.ts", skipFlag: "pavement", cadence: "weekly" },
];
