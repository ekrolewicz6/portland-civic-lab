...
export const answers: CandidateAnswer[] = [
  ...
  { candidateId: "barbara-j-kahl", question: "Education and school choice", text: "Federal incentives and school choice go hand in hand for me. I’d remove ESSA and replace it with STEP (Student Teacher Empowerment Act), refocusing schools on measurable academic progress in math, reading, writing, civics, history, and science (STEM), with the science of reading and critical thinking built in throughout, backed by a required 15 hours of continuing education (CE) per year of academic-rigor, neuroscience, and child development training for educators. Based on educational research, I’d remove tablets below 9th grade. I would add PE, music, and art as core K–6th grade subjects, adding electives of trades education, math and art, for 7th–12th grades, handing that control back to states and districts. [...] Rural and underserved communities will be on an equal playing field to receive funding. That same principle—funding follows the student—drives my view on school choice. Administrative staff in schools has grown extensively while teacher staffing levels have fallen behind; I want to flip that by funding teachers and reducing class sizes. The administrative budget can be redirected to teacher salaries. [...] Where public education isn’t the right fit, funding should follow the student rather than staying locked to the district. [...] Bring back academics, smaller class sizes, and more teachers, and we wouldn’t be having this discussion.", received: "2026-09-25" },
