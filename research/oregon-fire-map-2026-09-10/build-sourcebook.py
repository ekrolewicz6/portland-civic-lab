...
sections = [
    ...
    ('outreach', 'Outreach drafts and sent requests', 'outreach-drafts.md'),
...
<header><div class="status">Portland Civic Lab · Research edition · September 22, 2026</div><h1>Oregon Fire Map<br>Sourcebook</h1><p>Edan Krolewicz · Dominic Kuklawood</p><p>Documented burns, their purposes and Oregon wildfire history. Enough public data for a first map; visible gaps and source-specific evidence, with no claim of comprehensive coverage.</p><p>ODF and ODA requests sent September 22, 2026; other outreach unsent. The initial map is live at portlandciviclab.org/oregon-fire. This file supersedes the original September 10 sourcebook.</p></header>
