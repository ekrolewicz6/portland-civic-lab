    ...
    <div className="grid gap-4 lg:grid-cols-2">
      ...
      <div className="rounded-sm border border-[var(--color-parchment)] bg-white p-5 sm:p-7">
        ...
        <div className="mt-5 space-y-4">
          <div>
            <div className="flex items-baseline justify-between font-mono text-[11px] uppercase tracking-[0.1em] text-[var(--color-ink-muted)]">
              <span>Ongoing revenue</span>
              <span className="text-[13px] font-bold tabular-nums text-[var(--color-canopy)]">${FISCAL.ongoingRevenueM}M</span>
            </div>
          ...
          <div>
            <div className="flex items-baseline justify-between font-mono text-[11px] uppercase tracking-[0.1em] text-[var(--color-ink-muted)]">
              ...
              <span className="text-[13px] font-bold tabular-nums text-[var(--color-clay)]">${FISCAL.ongoingExpenseM}M</span>
            </div>
            <div className="relative mt-1.5 h-9 w-full rounded-sm bg-[var(--color-paper-warm)]">
              ...
              <span className="absolute right-2 top-1/2 -translate-y-1/2 font-mono text-[11px] font-bold text-white">
        ...
        <div className="mt-4 rounded-sm bg-[var(--color-paper-warm)] p-3.5">
          ...
          <p className="mt-1 text-[13px] text-[var(--color-ink)]">{FISCAL.reductionItems.join(" · ")}</p>
        </div>
      </div>
      ...
      <div className="rounded-sm border border-[var(--color-parchment)] bg-white p-5 sm:p-7">
          ...
          {POTS.map((p) => (
            <li key={p.label}>
              <div className="flex items-baseline justify-between gap-3">
                ...
                <span className="font-mono text-[14px] font-bold tabular-nums" style={{ color: p.tone }}>${p.v}M</span>
              </div>
              ...
              <p className="mt-0.5 text-[11px] text-[var(--color-ink-muted)]">{p.note}</p>
            </li>
          ))}
        </ul>
        <div className="mt-5 border-t border-[var(--color-parchment)] pt-4">
          <div className="flex items-baseline justify-between gap-3">
            ...
            <span className="font-mono text-[14px] font-bold tabular-nums text-[var(--color-clay)]">${buildingTotal}M</span>
          </div>
